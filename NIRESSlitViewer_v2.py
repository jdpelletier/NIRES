...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger):
        ...
        self.wtogglecomp.setEnabled(False)
        ...
        self.wmovSlitCent.setStyleSheet("background-color: blue")
        ...
        self.wmovObj.setStyleSheet("background-color: blue")
    ...
    def load_file(self, filepath):
        ...
        try:
            ...
            try:
                ...
                pass
            if 'snapi.fits' in filepath or 'disp.fits' in filepath:
                os.remove(filepath)
