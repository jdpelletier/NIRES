...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger):
        ...
        self.wzoomin.setMaximumSize(QtCore.QSize(100, 40))
        ...
        self.wzoomreset.setMaximumSize(QtCore.QSize(100, 40))
        ...
        self.wzoomout.setMaximumSize(QtCore.QSize(100, 40))
        ...
        self.wsetpan.setMaximumSize(QtCore.QSize(100, 40))
        ...
        self.wrecenter.setMaximumSize(QtCore.QSize(100, 40))
