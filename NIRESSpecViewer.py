...
class FitsViewer(QtGui.QMainWindow):
    ...
    def __init__(self, logger):
        ...
        display_hbox = QtGui.QHBoxLayout()
        display_hbox.setObjectName("display_hbox")
        self.xreadout = QtGui.QLabel("X:     ")
        self.xreadout.setObjectName("xreadout")
        # self.xreadout.setMaximumSize(QtCore.QSize(10, 10))
        display_hbox.addWidget(self.xreadout)
        self.yreadout = QtGui.QLabel("Y:     ")
        self.yreadout.setObjectName("yreadout")
        # self.yreadout.setMaximumSize(QtCore.QSize(10, 10))
        display_hbox.addWidget(self.yreadout)
        self.vreadout = QtGui.QLabel("Value:     ")
        self.vreadout.setObjectName("xreadout")
        # self.vreadout.setMaximumSize(QtCore.QSize(10, 10))
        display_hbox.addWidget(self.vreadout)
        self.wreadout = QtGui.QLabel("Wavelength:     ")
        self.wreadout.setObjectName("wreadout")
        # self.wreadout.setMaximumSize(QtCore.QSize(10, 10))
        display_hbox.addWidget(self.wreadout)
        ...
        display_hbox.setContentsMargins(QtCore.QMargins(4,1,4,1))
        # readout_hbox.setMaximumSize(QtCore.QSize(50, 10))
        hw = QtGui.QWidget()
        hw.setLayout(display_hbox)
        readout_hbox.addWidget(hw)
        spacer_hbox1 = QtGui.QHBoxLayout()
        hw = QtGui.QWidget()
        hw.setLayout(spacer_hbox1)
        readout_hbox.addWidget(hw)
        spacer_hbox2 = QtGui.QHBoxLayout()
        hw = QtGui.QWidget()
        hw.setLayout(spacer_hbox2)
        readout_hbox.addWidget(hw)
        hw = QtGui.QWidget()
    ...
    def motion_cb(self, viewer, button, data_x, data_y):
        ...
        if (fits_x > 2048 or fits_x <0) or (fits_y > 2048 or fits_y <0):
            ...
            self.vreadout.setText(f"Value: ")
            self.wreadout.setText(f"Wavelength: ")
        else:
            self.xreadout.setText(f"X: {int(fits_x)}")
            self.yreadout.setText(f"Y: {int(fits_y)}")
            self.vreadout.setText(f"Value: {value}")
            self.wreadout.setText(f"Wavelength: {wavelength}")
